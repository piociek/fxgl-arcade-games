...
public abstract class SpaceInvadersConstants {
    ...
    public static final Double PLAYER_HEIGHT = 35.0;
    ...
    public static final Double ENEMY_WIDTH = 35.0;
    public static final Double ENEMY_HEIGHT = 35.0;
    public static final Integer ENEMY_ROW_COUNT = 5;
    public static final Integer ENEMY_COUNT_PER_ROW = 12;
    public static final Integer ENEMY_SPACING = 15;
    ...
    public static final Double UFO_WIDTH = 35.0;
    public static final Double UFO_HEIGHT = 35.0;
